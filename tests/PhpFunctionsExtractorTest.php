...
use Gettext\Extractor\PhpFunctionsExtractor;
use PHPUnit\Framework\TestCase;

class PhpFunctionsExtractorTest extends TestCase
{
    public function testPhpFunctionsExtractor()
    {
        $extractor = new PhpFunctionsExtractor();
        $file = __DIR__.'/assets/functions.php';
        $code = file_get_contents($file);
        $functions = $extractor->extractFunctions($code, $file);
        ...
        $this->assertSame('This is a comment to fn9', $comment->getComment());
